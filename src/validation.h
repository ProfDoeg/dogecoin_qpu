...
/** Default for -quipuindex — the keyless quipu read-index (address + spent) */
static const bool DEFAULT_QUIPUINDEX = false;
...
/** quipu read-index accessors (keyless) — used by the quipu RPC */
